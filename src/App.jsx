  ...
  return (
    <div style={{ minHeight:"100vh", background:"var(--dark)" }}>
      ...
      <header className="site-header">
        ...
        <div style={{ width:60, height:2, background:"var(--fucsia,#e0458a)", margin:"0 auto 18px" }} />
        ...
        <div style={{ display:"inline-block", background:"var(--gold-dim)", border:"1px solid var(--gold)", padding:"8px 24px", borderRadius:2 }}>
          <span style={{ fontSize:15, color:"var(--gold-light)", fontFamily:"'Archivo Narrow',sans-serif", letterSpacing:".06em" }}>
            Valor reserva online: ${CONFIG.PRECIO_PB.toLocaleString("es-AR")} por entrada
          </span>
        </div>
      </header>
